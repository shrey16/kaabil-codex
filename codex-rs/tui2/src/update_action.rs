...
pub enum UpdateAction {
    /// Update via `npm install -g @kaabil/codex@latest`.
    NpmGlobalLatest,
    /// Update via `bun install -g @kaabil/codex@latest`.
    BunGlobalLatest,
...
impl UpdateAction {
    ...
    pub fn command_args(self) -> (&'static str, &'static [&'static str]) {
        match self {
            UpdateAction::NpmGlobalLatest => ("npm", &["install", "-g", "@kaabil/codex"]),
            UpdateAction::BunGlobalLatest => ("bun", &["install", "-g", "@kaabil/codex"]),
